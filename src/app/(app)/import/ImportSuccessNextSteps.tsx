...
export function ImportSuccessNextSteps({
  ...
  return (
    <div className="mt-2 rounded-lg border border-emerald-200/80 bg-emerald-50/80 px-3 py-2 text-xs text-emerald-950 dark:border-emerald-900/50 dark:bg-emerald-950/30 dark:text-emerald-100">
      <p className="font-medium">Imported {n} row{n === 1 ? "" : "s"} — next for {yearMonth}</p>
      <ul className="mt-1 list-inside list-disc space-y-0.5 text-emerald-900/90 dark:text-emerald-100/85">
        <li>

...
export function BudgetCopyHeader({
  ...
  return (
    <form
      ...
      className="mt-4 max-w-xl space-y-2 rounded-lg border border-border bg-muted/50 p-3 dark:border-zinc-700 dark:bg-zinc-900/40"
    >
      ...
      <div>
        <button
          type="submit"
          className="rounded-lg border border-zinc-300 bg-white px-3 py-1.5 text-xs font-medium hover:bg-muted dark:border-zinc-600 dark:bg-zinc-900 dark:hover:bg-zinc-800"
        >

...
export function ReceiptBatchExpensesForm({
  ...
  return (
    <form action={action} className="mt-2 space-y-2">
      ...
      <ReceiptLineItemsEditor initialLines={parsedLines} />
      ...
      >
        {pending ? "Posting…" : `Post line items as expenses`}
      </button>
      <p className="text-[10px] text-zinc-500">
        One split group ({lineCount} parsed line{lineCount === 1 ? "" : "s"}). Won’t
        run if any expense already uses this receipt.
      </p>
